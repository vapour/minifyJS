    ...
    var fileSystem = {
        ...
        renderList: function (dirname) { //render files list
            ...
            fs.readdir(dirname, function (err, files) {
                ...
                if (!err) {
                    if (dirname !== path.sep) {
                        list.push('<li><a href="' + path.dirname(dirname) + '" data-action="cd-directory">..</a></li>');
                    }
        ...
        renderNav: function (dirname) { //render nav
            var list = [], root = path.sep, arr;
            if (dirname === root) {
                list = '<a href="' + root + '">root</a>';
            } else {
